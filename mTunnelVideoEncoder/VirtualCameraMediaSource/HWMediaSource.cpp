...
namespace winrt::WindowsSample::implementation
{
    ...
    HRESULT HWMediaSource::InitPresentationDescriptor()
    {
        HRESULT hr = S_OK;
        DWORD cStreams = 1;  // only one stream should be detected
        ...
        hr = m_streamList[0]->GetStreamDescriptor(&ppSD[0]);
       

        // Create the presentation descriptor.
        hr = MFCreatePresentationDescriptor(cStreams, ppSD, &m_pPresentationDescriptor);
        ...
        )
    {
        ...
        *ppPresentationDescriptor = nullptr;
        ...
        HRESULT hr = m_pPresentationDescriptor->Clone(ppPresentationDescriptor);
