...
namespace winrt::WindowsSample::implementation
{
    ...
    {
        std::cout << "begin GetCharacteristics" << std::endl;
        winrt::slim_lock_guard lock(m_Lock);
    ...
    {
        std::cout << "begin Get service" << std::endl;
        winrt::slim_lock_guard lock(m_Lock);
    ...
    {
        std::cout << "begin SetDefaultAllocator" << std::endl;
        winrt::slim_lock_guard lock(m_Lock);
        RETURN_IF_FAILED(_CheckShutdownRequiresLock());
...
*/
        std::cout << "asdahdahdkaf" << std::endl;
        }
